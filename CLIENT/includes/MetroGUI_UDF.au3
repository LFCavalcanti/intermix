...
;				   $AllowDrag			- [Optional] True/False. Default is False. ;Enables drag of the window.
...
; ===============================================================================================================================
Func _Metro_CreateGUI($Title, $Width, $Height, $Left = -1, $Top = -1, $AllowResize = False, $AllowDrag = False, $ParentGUI = "")
	Local $GUI_Return
	...
	If $AllowResize Then
		...
		Else
			_Metro_SetGUIOption($GUI_Return, False, True, $Width, $Height)
		EndIf
